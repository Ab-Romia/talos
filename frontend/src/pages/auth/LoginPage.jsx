  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex w-1/2 bg-amber-subtle flex-col items-center justify-center p-12">
        ...
        {/* Abstract illustration — layered documents */}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-12 bg-base">
        <form onSubmit={handleSubmit} className="w-full max-w-[400px]">
          ...
          {error && (
            <Alert severity="error" onClose={() => dispatch(clearError())} className="mb-6">
              {error}
            </Alert>
          )}
          {oauthError && (
            <Alert severity="warning" onClose={() => setOauthError('')} className="mb-6" sx={{ mb: 2 }}>
              {oauthError}
            </Alert>
          )}
          ...
          <Button
            variant="outlined"
            fullWidth
            onClick={() => setOauthError('Google authentication is not configured yet')}
            className="mb-3"
          ...
          <Button
            variant="outlined"
            fullWidth
            onClick={() => setOauthError('GitHub authentication is not configured yet')}
          ...
          <div className="flex justify-end mb-6">
            <button
              type="button"
              onClick={() => setOauthError('Password reset is not available yet')}
